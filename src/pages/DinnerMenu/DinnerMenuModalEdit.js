...
const DinnerMenuModalEdit = ({ EditData, openedit, setOpenedit, handleCloseedit, user }) => {
    ...
    const UpcomingEvent = async () => {
        ...
        try {
            ...
            formData.append('tag_name', 'Lunch & Dinner Menu');
            ...
            if (status) {
                Swal.fire({
                    title: 'Good job!',
                    text: 'Dinner Menu Successfully Updated',
                    icon: 'success',
                    button: 'Ok',
                });
        ...
        >
            <Box>
                <Box sx={style}>
                    ...
                    >
                        {loader ? 'Loading...' : 'Update Dinner Menu'}
                    </Button>
                </Box>
            </Box>
        </Modal>
...
export default DinnerMenuModalEdit;
