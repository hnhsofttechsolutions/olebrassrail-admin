...
const DailySpecialsEdit = ({ EditData, openedit, setOpenedit, handleCloseedit, user }) => {
    ...
    const UpcomingEvent = async () => {
        ...
        try {
            ...
            formData.append('tag_name', 'Daily Specials');
            ...
            if (status) {
                Swal.fire({
                    title: 'Good job!',
                    text: 'Daily Specials Manu Successfully Updated',
                    icon: 'success',
                    button: 'Ok',
                });
        ...
        >
            <Box>
                <Box sx={style}>
                    ...
                    >
                        {loader ? 'Loading...' : 'Update Daily Specials Manu'}
                    </Button>
                </Box>
            </Box>
        </Modal>
...
export default DailySpecialsEdit;
